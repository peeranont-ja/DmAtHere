...
class HowToUsePenfillFragment : Fragment() {
//    private val fullScreenHelper = FullScreenHelper()

    companion object {
        fun newInstance(): HowToUsePenfillFragment {
            val fragment = HowToUsePenfillFragment()
            val args = Bundle()
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        return inflater.inflate(R.layout.fragment_how_to_use_pen_fill, container, false)
    }
